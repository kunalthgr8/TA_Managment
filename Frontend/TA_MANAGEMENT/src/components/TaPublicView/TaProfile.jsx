...
function TaProfile() {
  return (
    <div className="flex flex-col md:flex-row justify-center gap-5 self-center bg-white p-8 rounded-lg border-2 border-custom-gray shadow-slate-700">
      <div>
      ...
      <div className="w-3/4 flex flex-col m-5">
        ...
        <div>
          ...
          <div className="flex flex-row justify-start self-center gap-3 text-lg mt-2 ">
            <p className="text-sm text-gray-500 cursor-pointer">xyz@gmail.com</p>
            <p className="text-sm text-gray-500 cursor-pointer">xxxxx-xxxxx</p>
            <p className="text-sm text-gray-500 cursor-pointer">CSE </p>
            <p className="text-sm text-gray-500 cursor-pointer">Resume</p>
          </div>
        </div>
      </div>
    </div>
